...
foreach ($timetable as $entry) {
  ...
  if ($result && $result->num_rows == 0) {
    // Insert new record
    $insertQuery = "INSERT INTO tt (semester, section, day, time, subject, faculty, room) VALUES ('$semester', '$section', '$day', '$time', '$subject', '$faculty', '$room')";
